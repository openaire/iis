...
public class AffExtractionJob {
    ...
    public static void main(String[] args) throws IOException {
        AffExtractionJobParameters params = new AffExtractionJobParameters();
        ...
        try (JavaSparkContext sc = JavaSparkContextFactory.withConfAndKryo(new SparkConf())) {
            ...
            JavaRDD<DocumentTextWithChecksum> inputRecords = avroLoader.loadJavaRDD(sc, params.inputAvroPath,
                    DocumentTextWithChecksum.class);
...
//            avroSaver.saveJavaRDD(outputRecords, AffiliationExtractionResult.SCHEMA$, params.outputAvroPath);
    ...
    private static class AffExtractionJobParameters {
