 ...
 * 
 * Processes {@link DocumentTextWithChecksum} input records and calculates provides output generated by the script.
 * 
 * @author mhorst
 */
public class CachedHtmlImportAndExtractionJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (SparkSession session = SparkSessionFactory.withConfAndKryo(new SparkConf())) {
            ...
            JavaRDD<DocumentTextWithChecksum> importedHTMLs = grouped.flatMap(tuple -> {
            ...
            JavaRDD<DocumentTextWithChecksum> repartRecords = shouldRepartition(params.numberOfPartitions)
