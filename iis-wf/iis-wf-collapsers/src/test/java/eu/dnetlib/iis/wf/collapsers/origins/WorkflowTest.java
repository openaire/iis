...
public class WorkflowTest extends AbstractOozieWorkflowTestCase {
    ...
    public void testDefaultWorkflow() throws Exception {
        testWorkflow("eu/dnetlib/iis/wf/collapsers/origins_collapser/default");
    }

/*
    @Test
    public void testCitationWorkflow() throws Exception {
        testWorkflow("eu/dnetlib/iis/wf/collapsers/collapser/citation");
    }
*/
    
    @Test
    public void testDocumentTextWorkflow() throws Exception {
        testWorkflow("eu/dnetlib/iis/wf/collapsers/origins_collapser/documenttext");
    }
