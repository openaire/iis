...
insert into tara_match 
select c1 as docid, case when count>0 then id else case when var('tara_unidentified') and generalmatch then var('tara_unidentified') else null end end as id, 0.7 as confidence from (
