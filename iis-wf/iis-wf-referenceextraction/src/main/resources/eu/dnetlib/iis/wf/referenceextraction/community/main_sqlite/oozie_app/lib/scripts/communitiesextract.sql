...
from (
  setschema 'docid,prev,middle,next' select c1, textwindow2s(comprspaces(regexpr("\n", C2, " ")),10,3,10, '(?i)(?:\bCLARIAH\b)|(?:\bLINDAT\b)|(?:\bDLU\b)|(?:\bDutch Language Union\b)|(?:\bCELR\b)|(?:\bCLARINO\b)|(\bCLARIN\b)|(?:\bCLaDA-BG\b)') from pubs where c2 is not null
...
(regexprmatches('(?:\bCLARIN[\./\s\-]D\b)|(?:\bCLARIAH\b)|(?:\bCLARIN[\./\s\-]AT\b)|(?:\bLINDAT\b)|(?:\bCLARIN[\./\s\-]DK\b)|(?:\bDutch Language Union\b)|(?:\bCELR\b)|(?:\bCLARINO\b)|(?:\bCLARIN[\./\s\-]PL\b)|(?:\bSWE[\./\s\-]CLARIN\b)|(?:\bCLARIN[\./\s\-]LT\b)|(?:\bCLARIN[\./\s\-]PT\b)|(?:\bCLaDA-BG\b)|(?:\bCLARIN[\./\s\-]EL\b)|(?:\bCLARIN[\./\s\-]SI\b)|(?:\bCLARIN[\./\s\-]UK\b)|(?:\bCLARIN[\./\s\-]IT\b)|(?:\bFIN-CLARIN\b)|(?:\bCLARIN[\./\s\-]LV\b)|(?:\bHUN-CLARIN\b)|(?:\bCLARIN[\./\s\-]FR\b)|(?:\bHR-CLARIN\b)', context) and regexprmatches('(?i)(?:\bgrants?\b)|(?:\bfunding\b)|(?:\bfunded\b)|(?:\bprojects?\b)|(?:\bnational\b)', context)) or 
...
select docid, conceptId, conceptLabel, stripchars(middle,'.)(,[]') as middle, prev||" "||middle||" "||next as context
from (
setschema 'docid,prev,middle,next' select c1, textwindow2s(comprspaces(regexpr("\n", C2, " ")),10,1,10, '\bInstruct\b') from pubs where c2 is not null
