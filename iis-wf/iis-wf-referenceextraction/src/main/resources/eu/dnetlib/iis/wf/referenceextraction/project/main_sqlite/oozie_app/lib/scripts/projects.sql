...
(regexpr("(\d{4}\-\d+)",regexpr("\-ANTICIPATE\-|\-ATTRACT\-|\-PRFB\-|\-BB2B\-",middle,"-")) = grantid and fundingclass1="INNOVIRIS" and regexprmatches("anticipate|attract|prfb|bb2b",lower(j2s(prev,middle,next))) )  or
