       ...
       when fundingClass1="EC"/* fp7 confidence */ then
            ...
            regexprmatches(var('fp7middlepos'),middle)+
                ...
                when fundingClass2="H2020" then
                    ...
                    regexpcountwords("h2020|horizon\s*2020|european\s*research\s*council|\berc\b|skłodowska|curie grant|marie\s*sklodowska\s*curie|marie\s*curie|european\s*commission|\beu\s*grant|\beu\s*project|\bec\s*grant|\bec\s*project|european\s*union",j2s(prevpack,middle,nextpack))
            end
       end as confidence
                from
