...
(regexpr("(\d{4}\-\d+)",regexpr("\-ANTICIPATE\-|\-ATTRACT\-|\-PRFB\-|\-BB2B\-",middle,"-")) = grantid and fundingclass1="INNOVIRIS" and (regexprmatches("innoviris|prfb",lower(j2s(prev,middle,next))) or regexprmatches("anticipate$|attract$",prev)) and regexprmatches("\banticipate\b|\battract\b|prfb|\bbb2b\b",lower(j2s(prev,middle,next))) )  or
