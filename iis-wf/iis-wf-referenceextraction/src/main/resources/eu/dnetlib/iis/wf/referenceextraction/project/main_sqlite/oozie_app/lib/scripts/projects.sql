...
(regexpr("(\w+\/\w+\/\w+)",middle) = grantid and (fundingclass1="RIF" or fundingclass1="RPF") and regexprmatches("cyprus|rpf|\brif\b|research promotion foundation|research innovation foundation",lower(j2s(prev,middle,next))) ) or
