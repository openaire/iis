...
public class WorkflowTest extends AbstractOozieWorkflowTestCase {
	...
	public void testMainSQLiteWorkflow() throws Exception{
		testWorkflow("eu/dnetlib/iis/wf/referenceextraction/dataset/main_sqlite/sampletest");
	}

    @Test
	public void testMainWorkflowWithoutReferences() throws Exception {
        testWorkflow("eu/dnetlib/iis/wf/referenceextraction/dataset/main/sampletest_without_references");
	}
