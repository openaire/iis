...
public class AffMatchingQualityTest {
    ...
    private void readResultsAndPrintQualityRate(List<String> expectedResultsJsonPaths) throws IOException {
        ...
        pringFalsePositivesFactor(expectedMatches, actualMatches);
    ...
    private void pringFalsePositivesFactor(List<MatchedOrganization> expectedMatches, List<MatchedOrganization> actualMatches) {
