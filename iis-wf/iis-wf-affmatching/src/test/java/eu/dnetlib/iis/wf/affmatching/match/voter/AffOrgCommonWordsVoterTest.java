...
public class AffOrgCommonWordsVoterTest {

    @InjectMocks
    private CommonWordsVoter voter = new CommonWordsVoter(of(','), 2, 0.8);
    ...
    public void setup() {
        ...
        voter.setRatioRelation(RatioRelation.WITH_REGARD_TO_ORG_WORDS);
        voter.setCommonSimilarWordCalculator(new CommonSimilarWordCalculator(0.8f));
    }
