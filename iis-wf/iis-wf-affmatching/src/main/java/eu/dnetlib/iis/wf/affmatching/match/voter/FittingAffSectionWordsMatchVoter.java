 ...
 * @author madryk
 */
public class FittingAffSectionWordsMatchVoter extends AbstractAffOrgMatchVoter {
     ...
     */
    public FittingAffSectionWordsMatchVoter(List<Character> charsToFilter, int wordToRemoveMaxLength, 
