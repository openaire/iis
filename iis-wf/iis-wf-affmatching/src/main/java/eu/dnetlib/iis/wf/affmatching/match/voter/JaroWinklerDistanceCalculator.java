 ...
 */
/**
 *  Copied from org.apache.lucene.search.spell.JaroWinklerDistance
 *  
 *  
 */
 ...
 */
class JaroWinklerDistanceCalculator {
   ...
   */
  public JaroWinklerDistanceCalculator() {}
  ...
  public static double getDistance(String s1, String s2) {
    ...
    float jw = j < 0.7 ? j : j + Math.min(0.1f, 1f / mtp[3]) * mtp[2]
        * (1 - j);
    return jw;
  }
