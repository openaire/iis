 ...
 * @author madryk
 */
public class AffiliationMainSectionBucketHasher implements BucketHasher<AffMatchAffiliation> {
    ...
    /**
     * Returns a hash of the passed {@link AffMatchAffiliation}.<br/>
     * Hash is generated from main (most significant) section of 
     * {@link AffMatchAffiliation#getOrganizationName()} using {@link OrganizationSectionHasher}.<br/>
     * 
    ...
    public String hash(AffMatchAffiliation affiliation) {
        ...
        List<OrganizationSection> sections = sectionsSplitter.splitToSectionsDetailed(affiliation.getOrganizationName());
