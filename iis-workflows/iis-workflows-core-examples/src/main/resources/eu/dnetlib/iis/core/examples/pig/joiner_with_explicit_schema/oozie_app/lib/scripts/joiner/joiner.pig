...
'input_schema_file', '$schema_input_person');

define AVRO_LOAD_DOCUMENT
org.apache.pig.piggybank.storage.avro.AvroStorage(
'input_schema_file', '$schema_input_document');

define AVRO_STORE_DOCS
org.apache.pig.piggybank.storage.avro.AvroStorage(
'index', '0',
'output_schema_file', '$schema_output_document_with_authors');

define AVRO_STORE_AUTHORS
org.apache.pig.piggybank.storage.avro.AvroStorage(
'index', '1',
'output_schema_file', '$schema_output_person_with_documents');

define AVRO_STORE_AGE
org.apache.pig.piggybank.storage.avro.AvroStorage(
'index', '2',
'output_schema_file', '$schema_output_person_age');
