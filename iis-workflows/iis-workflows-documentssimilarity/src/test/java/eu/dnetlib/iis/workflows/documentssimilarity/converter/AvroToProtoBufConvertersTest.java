package eu.dnetlib.iis.workflows.documentssimilarity.converter;

import eu.dnetlib.iis.documentssimilarity.schemas.DocumentMetadata;
import eu.dnetlib.iis.workflows.documentssimilarity.converter.DocumentMetadataAvroToProtoBufConverter;
import eu.dnetlib.iis.workflows.documentssimilarity.producer.DocumentAvroDatastoreProducer;
