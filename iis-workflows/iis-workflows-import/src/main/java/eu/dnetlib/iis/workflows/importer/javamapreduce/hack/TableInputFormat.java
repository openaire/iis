package eu.dnetlib.iis.workflows.importer.javamapreduce.hack;

import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.IMPORT_HBASE_REMOTE_ZOOKEEPER_CLIENTPORT;
import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.IMPORT_HBASE_REMOTE_ZOOKEEPER_QUORUM;
