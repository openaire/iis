package eu.dnetlib.iis.workflows.importer.mapred;

import static eu.dnetlib.iis.common.WorkflowRuntimeParameters.DEFAULT_CSV_DELIMITER;
import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.HBASE_ENCODING;
import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.IMPORT_APPROVED_DATASOURCES_CSV;
import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.IMPORT_INFERENCE_PROVENANCE_BLACKLIST;
import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.IMPORT_MERGE_BODY_WITH_UPDATES;
import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.IMPORT_SKIP_DELETED_BY_INFERENCE;
import static eu.dnetlib.iis.workflows.importer.ImportWorkflowRuntimeParameters.IMPORT_TRUST_LEVEL_THRESHOLD;
...
import eu.dnetlib.iis.workflows.importer.converter.CitationConverter;
import eu.dnetlib.iis.workflows.importer.converter.DeduplicationMappingConverter;
import eu.dnetlib.iis.workflows.importer.converter.DocumentMetadataConverter;
import eu.dnetlib.iis.workflows.importer.converter.DocumentToProjectConverter;
import eu.dnetlib.iis.workflows.importer.converter.PersonConverter;
import eu.dnetlib.iis.workflows.importer.converter.ProjectConverter;
import eu.dnetlib.iis.workflows.importer.input.approver.ComplexApprover;
import eu.dnetlib.iis.workflows.importer.input.approver.DataInfoBasedApprover;
import eu.dnetlib.iis.workflows.importer.input.approver.FieldApprover;
import eu.dnetlib.iis.workflows.importer.input.approver.OriginDatasourceApprover;
