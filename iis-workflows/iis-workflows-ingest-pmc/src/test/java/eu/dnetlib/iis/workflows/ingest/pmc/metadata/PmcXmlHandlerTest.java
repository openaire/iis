...
public class PmcXmlHandlerTest {
	...
	static final String xmlResourcesRootClassPath = "/eu/dnetlib/iis/workflows/ingest/pmc/metadata/data/";
	...
	public void testParsingJats10() throws Exception {
		saxParser.parse(inputStream = PmcXmlHandler.class
				.getResourceAsStream(xmlResourcesRootClassPath + "document_jats10.xml"), pmcXmlHandler);
	...
	public void testParsingJats10NestedInOAI() throws Exception {
		saxParser.parse(
				inputStream = PmcXmlHandler.class
						.getResourceAsStream(xmlResourcesRootClassPath + "document_jats10_nested_in_oai.xml"),
				pmcXmlHandler);
		checkJats10Metadata(metaBuilder.build());
	}
	...
	public void testParsingJats23NestedInOAI() throws Exception {
		saxParser.parse(
				inputStream = PmcXmlHandler.class
						.getResourceAsStream(xmlResourcesRootClassPath + "document_jats23_nested_in_oai.xml"),
				pmcXmlHandler);
	...
	public void testParsingLargeFile() throws Exception {
		saxParser.parse(
				inputStream = PmcXmlHandler.class.getResourceAsStream(
						xmlResourcesRootClassPath + "od_______908__365a50343d53774f68fa13800349d372.xml"),
				pmcXmlHandler);
		ExtractedDocumentMetadata meta = metaBuilder.build();
	...
	public void testParsingAffiliation() throws Exception {
		saxParser.parse(
				inputStream = PmcXmlHandler.class
						.getResourceAsStream(xmlResourcesRootClassPath + "document_with_affiliations.xml"),
				pmcXmlHandler);
		ExtractedDocumentMetadata meta = metaBuilder.build();
	...
	public void testSingleRefParsing() throws Exception {
		saxParser.parse(inputStream = PmcXmlHandler.class
				.getResourceAsStream(xmlResourcesRootClassPath + "single-ref-document.xml"), pmcXmlHandler);
		ExtractedDocumentMetadata meta = metaBuilder.build();
		assertNotNull(meta.getReferences());
	...
	public void testMixedTitleParsing() throws Exception {
		...
		saxParser.parse(
				inputStream = PmcXmlHandler.class.getResourceAsStream(
						xmlResourcesRootClassPath + "od_______908__0451fa1ded79a63729296731e53335c0.xml"),
				pmcXmlHandler);
		ExtractedDocumentMetadata meta = metaBuilder.build();
		assertNotNull(meta.getReferences());
	...
	public void testElementCitation() throws Exception {
		...
		saxParser.parse(
				inputStream = PmcXmlHandler.class.getResourceAsStream(
						xmlResourcesRootClassPath + "od_______908__0452195ccf851072fd097fc49bfbb9da.xml"),
				pmcXmlHandler);
		ExtractedDocumentMetadata meta = metaBuilder.build();
		assertNotNull(meta.getReferences());
