...
import static eu.dnetlib.iis.workflows.citationmatching.converter.BasicMetadataDataExtractionUtil.extractAuthors;
import static eu.dnetlib.iis.workflows.citationmatching.converter.BasicMetadataDataExtractionUtil.extractJournal;
import static eu.dnetlib.iis.workflows.citationmatching.converter.BasicMetadataDataExtractionUtil.extractPages;
import static eu.dnetlib.iis.workflows.citationmatching.converter.BasicMetadataDataExtractionUtil.extractTitle;
import static eu.dnetlib.iis.workflows.citationmatching.converter.BasicMetadataDataExtractionUtil.extractYear;
